...
public class CreateUserPostCallWithJsonFileTest {
    ...
    @Test
    public void createUserPostCallWithJsonFileTest() throws IOException {
        byte[] fileBytes = null;
        File file = new File("./src/test/java/api/test/data/user.json");
        ...
        Assert.assertTrue(apiGETResponse.text().contains("Ramesh Ch"));
